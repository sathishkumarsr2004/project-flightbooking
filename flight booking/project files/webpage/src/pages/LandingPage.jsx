    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Explore the World, One Flight at a Time!</h1>
            <p className="banner-p">Smart flight booking for travelers who crave adventure and discovery.</p>     
          </div>
        ...
        <div className="container">
            ...
            <span><h5>2025 KRISH Holidays FlightConnect - &copy; All rights reserved</h5></span>
